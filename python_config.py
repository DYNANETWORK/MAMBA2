...
if ENV:
    ...
    class Config(object):
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "MAMBA2")
        # Get a Free API Key from OCR.Space
        OCR_SPACE_API_KEY = os.environ.get("OCR_SPACE_API_KEY", None)
        # Send .get_id in any group with all your administration bots (added)
        G_BAN_LOGGER_GROUP = int(os.environ.get("G_BAN_LOGGER_GROUP", ""))
        ...
        AWAKE_PIC = os.environ.get("AWAKE_PIC", https://telegra.ph/file/a8a793a8716bdcc923fd3.jpg)
        ...
        UPSTREAM_REPO = os.environ.get(
            "UPSTREAM_REPO", "https://github.com/SUKHPAL443/MAMBA1"
        )
        MAMBA_STRING = os.environ.get("MAMBA_STRING", None)
        ...
        EXTRA_MAMBABOT = os.environ.get("EXTRA_MAMBABOT", "")
